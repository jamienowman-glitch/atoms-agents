...
export function FloatingIcon({
    ...
    return (
        <button
            ref={ref}
            className={`fixed z-40 w-14 h-14 rounded-full bg-neutral-900 text-white dark:bg-neutral-100 dark:text-neutral-900 shadow-lg flex items-center justify-center transition-transform duration-200 ${isToolbarOpen ? 'scale-105' : 'scale-100'}`}
