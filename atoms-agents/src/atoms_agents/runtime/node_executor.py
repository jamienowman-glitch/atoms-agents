...
from atoms_agents.registry.schemas import NodeCard, RunProfileCard
...
from atoms_agents.runtime.audit.events import AuditEvent, EventType
import uuid
# Will use gateways in future phases, for now scaffolding logic

from atoms_agents.nexus.client import NexusClient, NoOpNexusClient
from atoms_agents.runtime.context import AgentsRequestContext  # Type hint
from atoms_agents.runtime.gateway_resolution import resolve_gateway
from atoms_agents.runtime.canvas_mirror import CanvasMirror
from atoms_agents.runtime.memory_gateway import MemoryGateway, HttpMemoryGateway
...
class NodeExecutor:
    ...
    def execute_node(
        ...
        try:
            ...
            if is_neutral:
                # --- NEW GRAPH_LENS PATH ---
                from atoms_agents.runtime.runner import ComponentRunner
                ...
                from atoms_agents.runtime.gateway import CapabilityToggleRequest
                ...
                from atoms_agents.runtime.prompting.composer import compose_messages
    ...
    def _write_outputs(self, node: NodeCard, content: str) -> tuple[List[str], Dict[str, Any]]:
        from atoms_agents.runtime.artifact_writer import ArtifactWriter
