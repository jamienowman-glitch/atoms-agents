...
from atoms_core.src.construction.models import (
    BoQModel, BoQItem,
    Currency,
    CostAssumption,
    CostCatalog,
...
class BoQCostingService:
    ...
    def register_artifact(
        ...
        """
        if "base_currency" not in cost_model.meta:
            raise ValueError("Cost artifact metadata validation failed")

        # Stub
        return f"cost_{boq_model_id}_{cost_model.model_hash}_stub"
