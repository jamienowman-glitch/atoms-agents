...
from atoms_core.src.audio.audio_hits.service import AudioHitsService, get_audio_hits_service
from atoms_core.src.audio.audio_hits.models import HitDetectRequest, HitDetectResult
from atoms_core.src.audio.audio_loops.service import AudioLoopsService, get_audio_loops_service
from atoms_core.src.audio.audio_loops.models import LoopDetectRequest, LoopDetectResult
from atoms_core.src.audio.audio_voice_phrases.service import AudioVoicePhrasesService, get_audio_voice_phrases_service
from atoms_core.src.audio.audio_voice_phrases.models import VoicePhraseDetectRequest, VoicePhraseDetectResult

from atoms_core.src.audio.audio_field_to_samples.models import FieldToSamplesRequest, FieldToSamplesResult
