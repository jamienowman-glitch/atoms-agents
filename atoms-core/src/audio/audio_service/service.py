...
from atoms_core.src.audio.core.audio_text_bars.engine import run as align_run
from atoms_core.src.audio.core.audio_text_bars.types import AlignAudioTextBarsInput
from atoms_core.src.audio.core.beat_features.engine import run as beat_run
from atoms_core.src.audio.core.beat_features.types import BeatFeaturesInput
from atoms_core.src.audio.core.preprocess_basic_clean.engine import run as clean_run
from atoms_core.src.audio.core.preprocess_basic_clean.types import PreprocessBasicCleanInput
from atoms_core.src.audio.core.segment_ffmpeg.engine import run as segment_run
...
class AudioService:
    def __init__(self) -> None:
        ...
        try:
            self.gcs = None # GcsClient disabled
        except Exception:
            self.gcs = None
