...
from .dxf_adapter import dxf_to_cad_model
...
class CadIngestService:
    ...
    def register_artifact(
        ...
        Returns artifact ID.
        """
        # TODO: Port to atoms-core storage/media or wait for new media service.
        # Original code imported engines.media_v2 which is unavailable.
        # Mock implementation for now.
        return f"cad_{model.id}_stub"
