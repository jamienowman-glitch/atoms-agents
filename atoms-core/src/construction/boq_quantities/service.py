...
from atoms_core.src.construction.models import BoQItem, BoQModel, BoQResponse, Scope, UnitType
from .formulas import calculate_quantity, deterministic_boq_item_id
...
class BoQQuantitiesService:
    ...
    def register_artifact(
        ...
        """
        if boq_model.model_hash is None:
            raise ValueError("boq_quantities requires meta fields: model_hash")

        # Stub logic
        return f"boq_{semantic_model_id}_{boq_model.model_hash}_stub"
