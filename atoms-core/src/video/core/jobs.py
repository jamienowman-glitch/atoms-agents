...
class RenderJobRepository:
    ...
    def get(self, job_id: str, tenant_id: str) -> Optional[VideoRenderJob]:
        raise NotImplementedError
...
class FirestoreRenderJobRepository(RenderJobRepository):
    def __init__(self, client: Optional[object] = None) -> None:
        ...
        project = os.getenv("FIRESTORE_PROJECT_ID", os.getenv("GCP_PROJECT"))
    ...
    def get(self, job_id: str, tenant_id: str) -> Optional[VideoRenderJob]:
        snap = self._col(tenant_id).document(job_id).get()
