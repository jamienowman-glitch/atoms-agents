...
"""Planet runner: FPS camera automation on spherical surface."""

import math
from typing import Any

from .models import RunnerKeyframe
...
class PlanetRunner:
    """Simulates FPS camera movement grounded on spherical surface with consistent normals."""
    ...
    def simulate_run(
        ...
        """Returns a keyframe automation sequence that hugs the surface normal."""
