...
from atoms_muscle.src.audio.audio_separation.service import AudioSeparationService
...
def test_separation_flow():
    ...
    with patch("atoms_muscle.src.audio.audio_separation.service.check_dependencies") as mock_check, \
         patch("atoms_muscle.src.audio.audio_separation.service.run_demucs_separation") as mock_backend, \
