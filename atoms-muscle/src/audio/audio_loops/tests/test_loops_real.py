...
@patch("atoms_core.src.audio.audio_loops.service.get_media_service")
@patch("atoms_core.src.audio.audio_loops.service.GcsClient")
@patch("atoms_core.src.audio.audio_loops.service.shutil.which")
@patch("atoms_core.src.audio.audio_loops.service.subprocess.run")
@patch("atoms_core.src.audio.audio_loops.service.LibrosaLoopsBackend")
@patch("atoms_core.src.audio.audio_loops.service.HAS_LIBROSA", True)
def test_detect_loops_real(mock_backend_cls, mock_run, mock_which, mock_gcs, mock_get_media):
    ...
    from atoms_core.src.audio.audio_loops.backend import LoopCandidate
    ...
    with patch("atoms_core.src.audio.audio_loops.service.os.path.exists", return_value=True):
        with patch("atoms_core.src.audio.audio_loops.service.Path.read_bytes", return_value=b"FAKE_LOOP_BYTES"):
            with patch("atoms_core.src.audio.audio_loops.service.Path.unlink", return_value=None):
