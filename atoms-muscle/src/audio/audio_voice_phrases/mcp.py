...
from .service import AudioVoicePhrasesService

mcp = FastMCP("muscle-audio-audio_voice_phrases")

service = AudioVoicePhrasesService()

@mcp.tool()
@require_snax(tool_key="muscle-audio-audio_voice_phrases")
def run_audio_voice_phrases(input_path: str, **kwargs) -> dict:
    """
    Executes AudioVoicePhrasesService.
    """
    try:
