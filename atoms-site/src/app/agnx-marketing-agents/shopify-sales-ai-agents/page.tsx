...
export default function ShopifyAgents() {
    ...
    return (
        <>
            ...
            <main className="min-h-screen bg-white text-black pb-20 overflow-x-hidden relative">
                ...
                {/* Using Green to match Shopify branding */}
                <button
                    onClick={() => setIsMenuOpen(true)}
                    className="absolute top-6 left-6 text-green-600 hover:text-green-700 transition-colors z-[100] drop-shadow-md"
                ...
                <section className="flex flex-col items-center pb-12">
                    ...
                    <div className="mt-8 text-center px-6">
                        <p className="text-xs text-gray-500 uppercase tracking-widest mb-2">E-Commerce Optimization</p>
