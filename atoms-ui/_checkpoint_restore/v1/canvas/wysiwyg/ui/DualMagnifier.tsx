...
export function DualMagnifier({ activeMode, onModeSelect, activeTool, onToolSelect, toolOptions, modeOptions }: DualMagnifierProps) {
    ...
    return (
        <div className="flex flex-col items-center gap-1">
            ...
            {/* Labels */}
            <div className="flex justify-between w-full px-4 text-xs font-semibold tracking-wide uppercase text-neutral-500 dark:text-neutral-400">
                <div className="text-left w-1/2">{activeModeLabel}</div>
                <div className="text-right w-1/2">{activeToolLabel}</div>
            </div>
        </div>
    );
}
