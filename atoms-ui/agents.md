...
```text
canvases/{name}/
├── index.ts                # Exports Canvas
├── {Name}Canvas.tsx        # The Main Entry
├── blocks/
│   ├── Connected{Name}.tsx # The Controller
│   ├── molecules/
│   │   └── {Name}Grid.tsx  # The Molecule
│   ├── atoms/
│   │   └── {Name}Tile.tsx  # The Atom
│   └── modifiers/          # Optional (Rows, dividers)
└── logic/                  # Optional (Mappers)
