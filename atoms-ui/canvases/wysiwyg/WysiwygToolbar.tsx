...
export function WysiwygToolbar({ settingsContent, activeBlockId, activeBlockType = 'media' }: BottomControlsPanelProps) {
    ...
    return (
        <div className={`w-full h-full flex flex-col transition-all duration-300 ${visibilityClass}`}>
