        ...
        <>
            ...
            <main className="min-h-screen bg-black text-white pb-20 overflow-x-hidden relative">
                ...
                <button
                    ...
                    className="absolute top-6 left-6 text-white hover:text-gray-300 transition-colors z-[100] drop-shadow-md"
                ...
                {/* Tagline Section */}
                <section className="py-20 px-6 text-center bg-zinc-900 mx-4 rounded-3xl">
