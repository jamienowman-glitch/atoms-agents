...
export default function B2NutritionalGuidanceAgent() {
    ...
    return (
        <>
            ...
            <main className="min-h-screen bg-white text-black pb-20 overflow-x-hidden relative">
                {/* 
                   Custom Teal Menu 
                   Using hex #00E5FF (Bright Cyan/Teal) to match VO2 Agent.
                */}
                <button
                ...
                <div className="w-full flex items-center justify-center pt-0 pb-12 px-6 md:px-4">
                    <div className="w-full max-w-[80%] md:max-w-xl relative">
                        <Image
                            ...
                            alt="B2 Nutritional Guidance Agent"
                            width={0}
                            height={0}
                ...
                <section className="flex flex-col items-center pb-12">
                    <div className="mt-8 text-center px-6">
                        <p className="text-xs text-gray-500 uppercase tracking-widest mb-2">Nutritional Intelligence</p>
                        <p className="text-sm max-w-md mx-auto text-gray-600">
                            Personalized nutritional strategies adapted to your metabolic needs in real-time.
                        </p>
                    </div>
                </section>
                ...
                <section className="py-20 px-6 text-center bg-gray-50 mx-4 rounded-3xl">
                    <h2 className="text-3xl md:text-5xl font-black mb-8 tracking-tighter text-black">
                        FUEL. SUSTAIN. OPTIMIZE.
                    </h2>
                    <p className="max-w-2xl mx-auto text-gray-600 leading-relaxed">
                        B² Agents analyze your expenditure and recovery data to prescribe the precise fuel required for your next performance.
                    </p>
                </section>
