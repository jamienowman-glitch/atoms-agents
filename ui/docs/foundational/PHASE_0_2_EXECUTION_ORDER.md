...
Rationale: Most Gate 2 deliverables are merged (memory durable, durable replay, vector-ish ingest/retrieval, cost kill-switch with /ops/status, Azure stubs). Audit hash chaining remains; complete this before Gate 3 finalizes client propagation.
